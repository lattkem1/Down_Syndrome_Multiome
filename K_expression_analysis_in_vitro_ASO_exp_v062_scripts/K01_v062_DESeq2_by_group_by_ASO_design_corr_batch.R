...
gr_tab$group = gr_tab$target_design

gr_tab$group[gr_tab$target == "non_targeting"] = "non_targeting"
gr_tab$group[gr_tab$target == "no_ASO"] = "no_ASO"
...
t1 = bulk_data$deseq_results$BACH1_D2
