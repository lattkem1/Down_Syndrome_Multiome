...
load(file = paste0(out_dir,"J01a_bulk_data_with_DESeq_results.rda")) 
...
t1 = as.tibble(cbind(comp = rownames(overlap_mat_fract), overlap_mat_fract))
write_csv(t1, file = paste0(out_dir, script_ind, "overlap_mat_fract.csv"))
