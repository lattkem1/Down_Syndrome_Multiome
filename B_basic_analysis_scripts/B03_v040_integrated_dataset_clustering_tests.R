...
############################################################
# UMAP plots split by group vs library/sample/batch_seq/dev_PCW/stage
############################################################
...
t1 = FetchData(seur, vars = c("umap_1", "umap_2", "group", "library","sample", "stage", "dev_PCW", "batch_seq"))
