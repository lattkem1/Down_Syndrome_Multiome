...
clust_tab = read_csv(paste0(main_dir,"B_basic_analysis/B03_cluster_assignment_all.csv"))
...
t1 = seur@meta.data
t2 = t1 %>% group_by(cell_type, cluster_name, sample, stage, cluster_stage, cluster_sample) %>% summarise(N_cells = n())
