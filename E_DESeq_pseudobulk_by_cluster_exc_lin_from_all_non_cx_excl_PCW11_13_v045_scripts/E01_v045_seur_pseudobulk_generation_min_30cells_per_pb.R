...
out_dir = paste0(main_dir,"E_DESeq_pseudobulk_by_cluster_exc_lin_from_all_non_cx_excl_PCW11_13_v045/")
...
clust_tab = read_csv(paste0(main_dir,"C_subsetting_exc_lin_from_all_non_cx_excl_PCW11_13/C02_subset_cluster_assignment.csv"))

load(file = paste0(main_dir,"C_subsetting_exc_lin_from_all_non_cx_excl_PCW11_13/C03_seur_integr_labelled.rda")) 
